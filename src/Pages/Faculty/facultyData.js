const facultyData = {
    CS: [
        ...
        },
        {
            ...
            image: "../assets/faculty images/CS Faculty/dr. rana asif rehman.webp"
        },
        {
            name: "Dr. Saira Karim",
            position: "Associate Professor",
            office: "F-Block, 1st floor, Room 13 (NB-F-013)",
            email: "saira.karim@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. saira karim.webp"
        },
        {
            name: "Dr. Zeeshan Ali Khan",
            position: "Associate Professor",
            office: "F-Block, 1st floor, Room 27 (NB-F-027)",
            email: "zeeshanali.khan@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. zeeshan ali khan.webp"
        },
        {
            name: "Dr. Aatira Anum",
            position: "Assistant Professor",
            office: "F-Block, 1st floor, Room 44 (NB-F-044)",
            email: "aatira.anum@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. aatira anum.webp"
        },
        {
            name: "Dr. Abdul Qadeer",
            position: "Assistant Professor",
            office: "F-Block, 1st floor, Room 45 (NB-F-045)",
            email: "aqadeer@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. abdul qadeer.webp"
        },
        {
            name: "Dr. Ali Afzal Malik",
            position: "Assistant Professor",
            office: "A-Block, Ground floor, Room 145 (C-145)",
            email: "ali.afzal@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. ali afzal malik.webp"
        },
        {
            name: "Dr. Ammar Haider",
            position: "Assistant Professor",
            office: "F-Block, 1st floor, Room 26 (NB-F-026)",
            email: "ammar.haider@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. ammar haider.webp"
        },
        {
            name: "Dr. Asma Ahmad Farhan",
            position: "Assistant Professor",
            office: "D-Block, 1st floor, Room 157 (E-157)",
            email: "asma.ahmad@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. asma ahmad farhan.webp"
        },
        {
            ...
            image: "../assets/faculty images/CS Faculty/dr. faisal aslam.webp"
        },
        {
            name: "Dr. Hajra Waheed",
            position: "Assistant Professor",
            office: "F-Block, 1st floor, Room 61 (NB-F-061)",
            email: "hajra.waheed@nu.edu.pk",
            image: "../assets/faculty images/CS Faculty/dr. hajra waheed.webp"
        },
        {
