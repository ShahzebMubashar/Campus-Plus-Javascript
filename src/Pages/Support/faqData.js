...
const faqData = [
  {
    ...
    questions: [
      {
        question:
          "What are the best study habits for FAST University students?",
        answer:
      ...
      {
        question:
          "What are some popular student organizations at FAST University?",
        answer:
    ...
    questions: [
      {
        ...
        answer:
          "Academic advising is typically available in the Student Services office or through academic advisors.",
      },
      {
