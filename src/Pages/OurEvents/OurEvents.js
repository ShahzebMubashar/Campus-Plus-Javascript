...
const events = [
    {
        ...
        description: 'A gathering of AI enthusiasts, researchers, and industry leaders to discuss the latest trends in artificial intelligence.',
        date: '2024-06-15',
        day: 'Saturday',
        mode: 'Online',
    ...
    },
    {
        ...
        description: '24-hour hackathon focused on building solutions for social good. Teams will compete for exciting prizes.',
        date: '2024-07-01',
        day: 'Monday',
        mode: 'On-Campus',
        registrationLink: '',
    ...
    },
    {
        ...
        description: 'Expert panel to guide students on career choices, internships, and higher studies.',
        date: '2024-06-20',
        day: 'Thursday',
        mode: 'Online',
    ...
    return (
        <div className="our-events-page">
            ...
            <header className="events-header">
                <h1>Our Events</h1>
                <p>Stay updated with the latest happenings, workshops, and seminars at Campus Plus!</p>
            </header>
                    ...
                    <div className="event-card" key={idx}>
                        ...
                        <div className="event-details">
                            <div className="event-detail-row">
                                ...
                                <span className="event-value">{event.date} ({event.day})</span>
                            </div>
                            <div className="event-detail-row">
                            ...
                            <div className="event-detail-row">
                                ...
                                {event.registrationOpen && event.registrationLink ? (
                                    <a className="event-register-btn" href={event.registrationLink} target="_blank" rel="noopener noreferrer">Register</a>
                                ) : (
