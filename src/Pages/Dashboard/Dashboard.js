...
function Dashboard() {
  ...
  const [showBatchMailer, setShowBatchMailer] = useState(false);
  ...
  return (
    <AcademicDashboard
      ...
      showBatchMailer={showBatchMailer}
      setShowBatchMailer={setShowBatchMailer}
    />
  );
}

// Move AcademicDashboard outside Dashboard
function AcademicDashboard({
  ...
  return (
    <div className="academic-dashboard">
      ...
      {user.isAdmin && (
        <>
          <div className="admin-batch-mailer-trigger">
            <button
              className="open-batch-mailer-btn"
              onClick={() => setShowBatchMailer(true)}
            >
              📨 Send Batch Email
            </button>
          </div>
          {showBatchMailer && (
            <div className="batch-mailer-modal-overlay" onClick={() => setShowBatchMailer(false)}>
              <div className="batch-mailer-modal" onClick={e => e.stopPropagation()}>
                <div className="modal-header">
                  <h2>Send Batch Email</h2>
                  <button className="close-modal-btn" onClick={() => setShowBatchMailer(false)}>&times;</button>
                </div>
                <div className="modal-body">
                  <input
                    className="batch-mailer-subject"
                    type="text"
                    placeholder="Subject"
                    value={subject}
