        ...
        <section className="quotes">
            <div className="testimonial-section">
                ...
                >
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            ...
                            <span>{testimonial.name}<br />{testimonial.date}</span>
                        </div>
                    ))}
                </div>
                ...
                <div className="slideshow-controls">
                    <span
                        className="prev"
                        onClick={() => changeSlide((currentSlide - 1 + testimonials.length) % testimonials.length)}
                    >
                        &#10094;
                    </span>
                    <span
                        className="next"
                        onClick={() => changeSlide((currentSlide + 1) % testimonials.length)}
                    >
                        &#10095;
                    </span>
