                ...
                <div className="auth-wrapper">
                    <div className="auth-card">
                        ...
                        <div className="auth-header">
                            <div className="logo-section" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12 }}>
                                <img src={logo} alt="Campus Plus Logo" style={{ height: 38, width: 38, marginRight: 8 }} />
                                <span className="brand-name" style={{ fontWeight: 700, fontSize: '2rem', color: '#1e293b', letterSpacing: 0 }}>
                        ...
                        <div className="toggle-section">
                            <div className="toggle-container">
                                <div className={`toggle-background ${isLogin ? "login" : "signup"}`}>
                                ...
                                <div className={`form-content ${isLogin ? "login-mode" : "signup-mode"}`}>
                                    ...
                                    <div className="input-wrapper">
                                        <input
                                            ...
                                            placeholder=" "
                                        />
                                        <label htmlFor={isLogin ? "password" : "rollNumber"} className="modern-label">
