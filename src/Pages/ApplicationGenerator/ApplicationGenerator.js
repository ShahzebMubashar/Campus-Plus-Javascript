  ...
  return (
    <div className="application-generator">
      ...
      <header>
        ...
        <p>
          Generate applications for academic, organizational, and other
          purposes!
        </p>
      </header>
      {!showForm ? (
        ...
        <div className="appResultContainer">
          ...
          <div className="button-container">
            <button
              ...
              onClick={() => copyApplication(appBody)}
            >
              Copy Application
            </button>
            <button
              className="btn btn-info"
              onClick={() => downloadApplication(appBody)}
            >
