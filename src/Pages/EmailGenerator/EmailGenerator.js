...
export default function EmailGenerator() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description:
        "Explore internships, TA positions, and other support opportunities.",
      image: cardImage3,
    },
    {
      title: "Study Abroad",
      description:
        "Inquire about study abroad programs to enhance your experience.",
      image: cardImage4,
    },
    {
          ...
          <div className="appResultContainer">
            ...
            <div className="button-container">
              <button
                ...
                onClick={() => copyEmail(emailBody)}
              >
                Copy Application
              </button>
              <button
                className="btn btn-info"
                onClick={() => downloadEmail(emailBody)}
              >
