...
const HeroSection = () => {
  return (
    <section
      ...
      style={{ backgroundImage: "url(../assets/images/cover_1.webp)" }}
    >
        ...
        <div className="row">
          <div className="col-12">
            <h1 className="display-4" data-aos="zoom-in">
              Campus+ <br /> A oneStop Solution for All Fastians
            </h1>
            <p className="my-4" data-aos="fade-up">
              Empowering every FAST student to navigate their university life
